...
class YeeMusicLight:
    ...
    def setcol(self, r, g, b, brightness=None):
        #print(r, g, b)
        if r > 0.0 and g > 0.0 and b > 0.0:
            #print(r, g, b)
            #print(brightness)
            self.yee.send_color(r, g, b, brightness)
        else:
            self.yee.toggle()
    ...
    def run(self):
        try:
            ...
            while True:
                ...
                self.setcol(r_proc, g_proc, b_proc, brightness)
                
                sleep(self.loop_delay)

        except KeyboardInterrupt:
            print("Exiting YeeMusicLight.")
            self.setcol(0,0,0)
            self.stream.close()
            self.pa.terminate() 

if __name__ == "__main__":
    light_box = YeeMusicLight()
